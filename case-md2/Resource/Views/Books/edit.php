...
$book = $bookController->getBookById($_GET["edit-book"]);
if($_SERVER["REQUEST_METHOD"]=="POST"){
    $bookController->editBook($_GET["edit-book"],$_REQUEST);
}
?>
<!DOCTYPE html>
<html>
            ...
            <div class="col-md-6">
                <form role="form" method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Book Name" name="bookName" value="<?php echo $book['bookName']?>">
                    </div>
                    <div class="form-group">
                        <label>Amount</label>
                        <input type="number" class="form-control" name="amount" value="<?php echo $book['amount']?>">
                    </div>
                    <div class="form-group">
